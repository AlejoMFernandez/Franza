...
document.addEventListener("DOMContentLoaded", () => {
    fetch("../folders.json")
        ...
        .then(folders => {
            const contenedor = document.getElementById("contenedorObrasCiviles");
            contenedor.innerHTML = "";

            Object.entries(folders.ObrasCiviles).forEach(([folderName, data]) => {
                let obraindex = document.createElement("a");
                obraindex.classList.add("obracivil");
                obraindex.href = "obracivil.html?id=" + folderName;
                ...
                obraimg.src = `../img/obrasciviles/${folderName}/${folderName}.jpg`;
