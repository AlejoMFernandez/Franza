...
INSERT INTO `obras` VALUES (67,1,'reforma-de-azotea','Reforma de Azotea','San Miguel','La azotea presentaba problemas de filtraciones hacia la PB por fisuras en su revestimiento. Se reemplazaron los da├▒ados, previo a la reparaci├│n de la carpeta para generar el sello hidr├│fugo. Se quitaron y volvieron a generar las juntas de dilataci├│n con Poliuret├ínico de primera marca. Se pint├│ toda la superficie.','civil','AzoteaCaba_1771019121.jpg'),(68,1,'construccion-completa-de-hogar','Construccion completa de hogar','Barrio Cerrado ?','Explicaci├│n extensa de que se hizo','civil','CasaCharo_1771019219.jpg'),(69,1,'reforma-complete-de-balcon','Reforma complete de balcon','Villa del Parque','La zona de la terraza presentaba problemas de filtraciones hacia la PB por fisuras en su revestimiento. Se reemplazaron los da├▒ados, previo a la reparaci├│n de la carpeta para generar el sello hidr├│fugo. Se quitaron y volvieron a generar las juntas de dilataci├│n con Poliuret├ínico de primera marca. Se pint├│ toda la superficie. Paredes: Las mismas presentaban patolog├¡as graves por el ingreso constante de agua sobre un largo periodo de tiempo, generando asi una desconexi├│n entre el revoque y la mamp','civil','CasaVillaDelParque_1771019252.jpg'),(70,1,'obra-particular','Obra particular','Zona Norte GBA','Mediante un proyecto se realiz├│ la ampliaci├│n de una cocina existente en conexi├│n con un nuevo quincho. Se demolieron paredes y se generaron nuevos refuerzos. Mediante vigas de encadenados se mont├│ la nueva platea para soportar la carga del nuevo espacio. Se realiz├│ una parrilla completa, techo a dos aguas de tejas francesas, nuevas ventanas en techo de pa├▒o fijo, un ba├▒o y la ampliaci├│n de la cocina existente.','civil','JorgelinaZonaNorte_1771019309.jpg'),(71,1,'ampliaci-on-y-reforma-de-vivienda-unifamiliar','Ampliaci├│n y reforma de vivienda unifamiliar','San Isidro - GBA','Mediante un proyecto, se ejecut├│ esta obra que comprend├¡a el anexo de un nuevo espacio a uno existente y la reforma interna de los ambientes. Se realizaron tareas de hormig├│n visto - Pintura - Electricidad nueva - Gas - Aberturas - Techados - Aberturas Velux','civil','LambWeston_1771019353.jpg'),(72,1,'restauraci-on-de-fachada','Restauraci├│n de fachada','Mitre','Comenzamos con hidrolavado baja presi├│n, retiro de vegetaci├│n en griteas y sellado de las mismas. Se restauraron los ornamentos de la facha y se repararon las partes afectadas por la corrosi├│n debido a la exposici├│n del hierro de estructuras al agua. Se pint├│ con 4 manos de pintura para muros de primera calidad y se pintaron los frentes de los locales comerciales en la PB','civil','ObraBmeMitre_1771019414.jpg'),(73,1,'reforma-completa-de-hogar','Reforma completa de hogar','Tres de Febrero','La zona de la terraza presentaba problemas de filtraciones hacia la PB por fisuras en su revestimiento. Se reemplazaron los da├▒ados, previo a la reparaci├│n de la carpeta para generar el sello hidr├│fugo. Se quitaron y volvieron a generar las juntas de dilataci├│n con Poliuret├ínico de primera marca. Se pint├│ toda la superficie. Paredes: Las mismas presentaban patolog├¡as graves por el ingreso constante de agua sobre un largo periodo de tiempo, generando asi una desconexi├│n entre el revoque y la mamp','civil','ObraCanales_1771019471.jpg');
